...
➡️ **[Workshop-Datensatz herunterladen (CSV)](../workshops/ws1/assets/data/datensatz_workshop.csv)**  
➡️ **[Workshop-Datensatz herunterladen (SPSS)](../workshops/ws1/assets/data/spss_datensatz_workshop.sav)**

::: callout-warning
# **Wichtig**

Achte darauf, die Datei **nicht irgendwo auf dem Rechner**,  
sondern **im Projektordner** zu speichern.  
...
df_csv <- read_csv("data/datensatz_workshop.csv")

df_spss <- read_sav("data/spss_datensatz_workshop.sav")
```

::: callout-note
# Hinweis

Was fällt dir auf, wenn du die **Datensätze** mit einander vergleichst?
